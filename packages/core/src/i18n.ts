...
export const MESSAGES: Record<Locale, Record<string, Message>> = {
  en: {
    ...
    'gym.store.plan.period.month': 'month',
    'gym.store.plan.period.quarter': 'quarter',
    'gym.store.plan.period.year': 'year',
    'gym.store.plan.period.pass': 'pass',
  ...
  fr: {
    ...
    'gym.store.plan.period.month': 'mois',
    'gym.store.plan.period.quarter': 'trimestre',
    'gym.store.plan.period.year': 'an',
    'gym.store.plan.period.pass': 'pass',
