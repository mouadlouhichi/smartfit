...
const INTENTIONAL_COGNATES: Record<string, string> = {
  ...
  'landing.activity.cardio': 'French gyms say cardio.',
  ...
  'gym.studio.palette.volt': 'The palette names the colour “volt”, same in French.',
  'gym.studio.palette.rose': '“Rose” is the French word too.',
  'gym.studio.field.logo': '“Logo” is the French word too.',
