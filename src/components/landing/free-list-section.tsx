    ...
    <section ref={ref} className="relative overflow-hidden py-24 lg:py-32">
      <div className="mx-auto max-w-[1400px] px-6 lg:px-12">
        <div className="grid items-center gap-16 lg:grid-cols-2 lg:gap-24">
          <div
            className="reveal"
            data-state={visible ? 'visible' : 'hidden-left'}
          >
            ...
            <p className="mb-12 text-xl leading-relaxed text-[color:var(--muted-foreground)]">
              Every core feature is free with no time limit and no card. SmartFit is private by design — there is no
              premium tier and nothing to upsell.
            </p>

            <div className="grid grid-cols-3 gap-8">
              <div>
                <div className="mb-2 font-display text-4xl lg:text-5xl">$0</div>
          ...
          >
            <div className="border border-[color:var(--foreground)]/10">
              <div className="flex items-center justify-between border-b border-[color:var(--foreground)]/10 px-6 py-4">
                <span className="font-mono text-sm text-[color:var(--muted-foreground)]">What you get</span>
                    ...
                    <div className="flex items-center gap-4">
                      <span
                        className={`h-2 w-2 rounded-full transition-colors duration-300 ${
                          activePerk === index ? 'bg-[color:var(--foreground)]' : 'bg-[color:var(--foreground)]/20'
                        }`}
                      />
